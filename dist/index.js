...
var Dropdown = function (_a) {
    ...
    var _f = React.useState(false), dropdownMainClose = _f[0], setDropdownMainClose = _f[1];
    var _g = React.useState(false), dropdownChildClose = _g[0], setDropdownChildClose = _g[1];
